...
country_list = [(ip_address, get_continent(ip_address, reader), get_country(ip_address, reader), get_city(ip_address, reader)) for ip_address in ip_list]
...
with open("indirizzi_ip_con_paese.csv", mode="w", newline="") as csv_file:
    ...
    writer.writerow(["IP_Address", "Continent", "Country", "City"])
    for ip_address, continent, country, city in country_list:
        writer.writerow([ip_address, continent, country, city])