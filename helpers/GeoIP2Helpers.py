...
def generateCSVFromGeoIP2Module(lang: str="en", inputCSVFileName: str="IP.csv", outputCSVFileName: str="IP_con_geoip.csv"):
    ...
    try:
        ...
        with open(outputCSVFileName, mode="w", newline="", encoding="utf-8") as csv_file:
            try:
                geoip2Reader_ASN = geoip2.database.Reader("GeoLite2-ASN.mmdb")
                geoip2Reader_City = geoip2.database.Reader("GeoLite2-City.mmdb")
                geoip2Reader_Country = geoip2.database.Reader("GeoLite2-Country.mmdb")
